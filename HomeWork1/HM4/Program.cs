...
//    public void Print()
//    {
//        Console.WriteLine($"Ім'я: {Name}, Зарплата: {Salary} грн");
//    }
...
//    // Оператор порівняння != (його потрібно перевизначати разом з ==)
//    public static bool operator !=(Worker workerSalary1, Worker workerSalary2)
//    {
//        return !(workerSalary1 == workerSalary2);
//    }
...
//    // Перевизначення Equals() (рекомендується разом з ==)
...
//    // Перевизначення GetHashCode() (необхідне для коректної роботи ==)
...
//    static void Main()
//    {
//        Worker worker1 = new Worker("Olya", 300m);
//        Worker worker2 = new Worker("Anna", 300m);
//        Worker worker3 = new Worker("Ivan", 250m);

//        Console.WriteLine(worker1 == worker3); // true (зарплата однакова)
//        Console.WriteLine(worker1 != worker3); // true (зарплата різна)
//        Console.WriteLine(worker1 > worker3);  // true (300 > 250)
//        Console.WriteLine(worker3 < worker2);  // true (250 < 300)
//    }
